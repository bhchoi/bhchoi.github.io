...
pretrained model는 [KoBERT](https://github.com/SKTBrain/KoBERT){:target="_blank"}를 사용합니다.


BERT의 input은 다음와 같습니다. 
![bert_input.png](/assets/img/user/bert_input.png)
...
## Reference
* [SKTBrain/KoBERT](https://github.com/SKTBrain/KoBERT){:target="_blank"}
* [monologg/KoBERT-NER](https://github.com/monologg/KoBERT-NER){:target="_blank"}
